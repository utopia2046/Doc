...
def main():
    ...
    BASICFONT = pygame.font.Font('res\\freesansbold.ttf', 18)

    # A global dict value that will contain all the Pygame
    # Surface objects returned by pygame.image.load().
    IMAGESDICT = {'uncovered goal': pygame.image.load('res\\RedSelector.png'),
                  ...
                  'title': pygame.image.load('res\\star_title.png'),
    ...
    while True: # main game loop
        ...
        for event in pygame.event.get(): # event handling loop
            if event.type == QUIT:
                ...
                elif event.key == K_BACKSPACE or event.key == K_r:
