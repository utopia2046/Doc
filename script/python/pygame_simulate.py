...
def main():
    ...
    BEEP1 = pygame.mixer.Sound('..\\res\\beep1.ogg')
    BEEP2 = pygame.mixer.Sound('..\\res\\beep2.ogg')
    BEEP3 = pygame.mixer.Sound('..\\res\\beep3.ogg')
    BEEP4 = pygame.mixer.Sound('..\\res\\beep4.ogg')
